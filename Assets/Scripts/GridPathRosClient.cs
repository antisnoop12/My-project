...
{
    [SerializeField] private string requestTopic = "/grid_path_request"; [SerializeField] private string resultTopic = "/grid_path_result";
    ...
    [SerializeField]
    private Int3[] gridPoints = new Int3[]
    {
        new Int3(0, 0, 0),
        new Int3(0, 0, 200),
        new Int3(380, 0, 200),
        new Int3(380, 155, 200)
    };
